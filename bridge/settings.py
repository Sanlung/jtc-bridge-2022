...
ALLOWED_HOSTS = ['localhost', 'jtc-bridgeapp.onrender.com']
...
DATABASES = {
    'default': dj_database_url.config(conn_max_age=600) if "DATABASE_URL" in os.environ else {'ENGINE': 'django.db.backends.sqlite3', 'NAME': os.path.join(BASE_DIR, 'db.sqlite3')}
}
